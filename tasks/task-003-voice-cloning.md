...
- [x] `scripts/clone_voice.py` 파일 존재 및 실행 가능
- [x] `docs/03-cloning.md` 파일 존재
- [x] 학습 목표/사전 지식/산출물이 명시됨
- [x] CLI와 Python API 두 가지 방식 모두 설명
- [x] 한국어/영어 합성 예제 포함
- [x] 품질 평가 기준 및 트러블슈팅 포함
- [x] `PROGRESS.md`에 진행 상태 반영

## 실행 결과 요약

- 레퍼런스 오디오 준비: `samples/voice_ref_01_24k.wav` (24kHz, mono)
- 한국어 합성: `output/clone_ko_test.wav` 생성 확인
- 영어 합성: `output/clone_en_test.wav` 생성 확인
